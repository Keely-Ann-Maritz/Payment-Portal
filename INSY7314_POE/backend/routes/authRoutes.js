...
// calling rate limiting (Zanini, 2024)
const { rateLimit } = require("express-rate-limit");

const router = express.Router();

// Setting the limit to 5 minutes after too many attempts (Zanini, 2024)
...
// Including the rate limiting into the login form (Zanini, 2024)
