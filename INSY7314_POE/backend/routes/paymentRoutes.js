...
const { getPayments, getPayment, createPayment, updatePayment, deletePayment } = require('../controllers/paymentController.js');
...
// to get a specific payment, we pass through that payments ID
