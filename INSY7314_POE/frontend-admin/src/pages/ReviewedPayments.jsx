...
export default function ReviewedPayments({ setShowNavbar }) {
    ...
    const fetchPayments = async () => {
        ...
        const res = await getUpdatedStatusPayments();
    ...
    useEffect(() => {
        ...
        fetchPayments();
        //navigate("/ReviewedPayments");
    }, []);
 
    // Payment Table
    return (
        <div>
            <h1 className="paymentHistoryHeading">Reviewed Payments</h1>
            <div className="container mt-3">
                <table border="1" className="table table-hover">
                    ...
                    <tbody>
                        ...
                        {payments.length === 0 && (
                            <tr>
                                <td colSpan="5">No reviewed payments available.</td>
                            </tr>
                        )}
